    ...
    <>
      {
        loading ? <TitleDetailsSkeleton /> : (
          <div className=' ml-5 border-b-2 border-lightGray pb-6 [@media(max-width:870px)]:border-none [@media(max-width:870px)]:mr-2 [@media(max-width:870px)]:ml-5'>
            <div className='flex items-center mt-9 ml-3'>

              <img src={coins?.image.large} alt={coins?.name} className='ml-3 mr-3 size-12 [@media(max-width:870px)]:size-8'/> 
            ...
            <div className='flex items-center gap-5 flex-wrap ml-10 mt-9 [@media(max-width:870px)]:items-end [@media(max-width:870px)]:ml-2'>
